...
Movie.create(title: 'Xuxa e os Duendes',
             overview: 'Filmão cult, top demais, melhor filme já criado', poster_url: 'https://upload.wikimedia.org/wikipedia/pt/2/2d/Xuxa-e-os-duendes.jpg', rating: 6.9)
